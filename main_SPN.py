...
if __name__ == '__main__':
    ...
    parser.add_argument('--matcher', type=str, default="max", choices=['avg', 'min'])
    ...
    parser.add_argument('--bilstm_hidden_size', help='the size of hidden embedding', type=int, default=258)
